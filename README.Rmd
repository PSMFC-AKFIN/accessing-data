...
![example report on Answers](img/crab dashboard.jpg)
...
![The first time you connect you will have to specify some details, but you can save the connection so subsequent logins will only require your password.](img/sql_developer_new_connection.jpg)
...
![GAP_PRODUCTS tables in SQL developer](img/gap_sql_dev.jpg)
